...
export default function FloatingContactBadge() {
  ...
  const handleEmail = () => {
    const email = "info@thirdeyesourcing.com"
  ...
  return (
    <div className="fixed bottom-8 right-8 z-50">
      ...
      >
        ...
        <button
          onClick={handleEmail}
          className="group flex items-center gap-3 bg-white hover:bg-emerald-50 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 pr-5 pl-4 py-3 border border-gray-200"
        >
